...
MATERIALITY_SHOCKS = {
    "water_crisis": {
        ...
        "trigger_conditions": {"round_range": [4, 8], "probability": 0.08},
    },
    "supply_chain_collapse": {
        ...
        "trigger_conditions": {"round_range": [3, 9], "probability": 0.06},
    },
    "biodiversity_tipping": {
        ...
        "forced_reallocation_pct": 0.10,
        "trigger_conditions": {"round_range": [5, 9], "probability": 0.07},
    },
    "stranded_asset_reclassification": {
        ...
        "trigger_conditions": {"round_range": [6, 10], "probability": 0.09},
    },
}
...
def evaluate_materiality_shocks(
    ...
    """Evaluate which materiality shocks trigger this round."""
    from black_swan_registry import get_difficulty_config
    diff = get_difficulty_config(difficulty_tier)
    prob_mult = diff["probability_multiplier"]
