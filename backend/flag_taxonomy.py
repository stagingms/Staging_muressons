...
FLAG_TAXONOMY: dict[str, dict[str, str]] = {
    ...
    # ── FLAG-11 (audit 2026-09-04, WP-24): surfaced once the sweep stopped
    # counting a pillar OPTION KEY as a read and started reading BOM-prefixed
    # files. Same rulings as their neighbours: pillar option identity markers
    # (the router applies the option's impacts; the flag records the choice),
    # and ethics-track outcome markers (the track keeps its own accumulated
    # flags / score; the main-sim M_R promise stays unwired by the 2026-09-01
    # ruling).
    "adaptation_fund": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "automation_pivot": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "biodiversity_fund": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "closed_loop": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "community_water": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "digital_inclusion": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "digital_twin": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "dry_cooling": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "efficiency_upgrades": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "fossil_dependent": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "green_pivot": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "green_reskilling": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "green_tariff": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "heat_recovery": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "lean_process": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "local_ecosystem": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "manual_oversight": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "material_passport": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "microgrids": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "parametric_insurance": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "partial_retraining": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "regenerative_supply": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "resilient_network": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "reverse_logistics": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "stakeholder_covenant": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "targeted_fix": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "transition_bonds": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "voluntary_offsets": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "waste_reduction": {"class": "choice-marker", "declared_in": "pillar_configs.py"},
    "pr_containment": {"class": "choice-marker", "declared_in": "pillar_configs.py, round_configs.py"},
    "spinoff": {"class": "choice-marker", "declared_in": "pillar_configs.py, round_configs.py"},
    "es_ai_ethics_board": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_ai_quiet_fix": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_biodiversity_deferred": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_cobalt_certified": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_community_invested": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_green_claims_verified": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_greenwash_defended": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_just_transition_leader": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_legal_firewall": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_lobby_active": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_nature_positive": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_partial_conservation": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_partial_correction": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_phased_transition": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_sbti_aligned": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_supplier_terminated": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_tnfd_disclosed": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_transparency_leader": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_union_strike_risk": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_whistleblower_risk": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
    "es_workers_abandoned": {"class": "narrative", "declared_in": "side_tracks/ethics_sustainability/configs.py"},
}
...
TAXONOMY_REASONS: dict[str, str] = {
    ...
    "side_tracks/ethics_sustainability/configs.py": "Ethics & sustainability side-track outcome marker; the track reads its own accumulated_flags and es_track_mr_bonus stays unwired by the 2026-09-01 ruling (FLAG-11: invisible to the old sweep behind a UTF-8 BOM).",
}
