...
| Supply-chain transparency described as a moving score | §4.1 — constant at 40.0 for every session graded under 2026.09 | **PARTLY FIXED** — Ch 6 §6.3's worked chain (a Round 1 deep audit "adds 20", cutting the nature premium to 0.54%) now records that the lever was inert until 8 September. Still open: the audit findings in Book Part 4/5 and Appendices A/B describe the six transparency deltas as dead, which is true of 2026.09 and no longer true of 2026.10 |
