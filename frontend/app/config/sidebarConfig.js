...
export const FACILITATOR_SIDEBAR = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'impersonate',    label: 'Session State Inspector', icon: '🔍', liveRound: true, tooltip: 'Inspect the financial metrics, business unit operating margins, and active event flags for any enrolled session. Answers: "What is the current financial state and risk posture of this specific session?"' },
