...
export const FACILITATOR_SIDEBAR = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'esg_weights',         label: 'ESG Profile Weights',    icon: '🎚️', requiredRole: 'lead_facilitator', tooltip: 'Tune the weight each performance signal carries in the five ESG Leadership Profile dimensions (Climate Resilience, Governance, Social Impact, Environmental, Innovation) shown to players at game end. Sets the global assessment rubric. Lead facilitators and super admins only. Answers: "How is the end-of-game ESG radar scored, and how do I reweight it?"' },
