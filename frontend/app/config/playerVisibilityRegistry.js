...
export const PLAYER_VISIBILITY_CARDS = [
    ...
    { key: 'three_key_insights', label: '3 Key Insights', icon: '💡', group: 'End of game & debrief', tooltip: 'Auto-derived Best Decision / Most Costly Mistake / Road Not Taken.', audience: 'debrief' },
