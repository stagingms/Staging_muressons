                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                <div style={{
                                    ...
                                    {[
                                        ...
                                        { key: 'board_room_moments_enabled', label: '🏢 Board Room', default: true, tip: 'Board Room Moment — a guided post-round reflection (Noticing → Making Sense → Working with Meaning) that appears after each round\'s results are reviewed. Turn off to hide it.' },
                                        { key: 'consequence_map_enabled', label: '🗺️ Consequence Map', default: true, tip: 'Decision Consequence Map — the results-view timeline that links each round\'s decisions to their downstream governance / climate / risk / social / supply-chain / strategic effects. Turn off to hide it.' },
                                        ...
                                        { key: 'briefing_theory_enabled', label: '📚 Briefing Theory', default: false, tip: 'Shows academic framing on the PLAYER round-briefing screens — the “Academic Framework” theory card and the theory citations woven into the narrative (CSRD, ISSB, Mendelow, ILO, etc.). OFF by default: players see the scenario without textbook asides. Facilitators keep the full pedagogy in the teleprompter regardless.' },
                                        ...
                                        { key: 'r6_revelation_enabled', label: '🚨 R6 Twist', default: false, tip: 'Round 6 narrative twist: a major revelation event (e.g. supply chain scandal, regulatory change) that forces strategic pivot. Reflection exercise — recorded for the debrief, no engine effect. OFF by default.' },
                                        { key: 'r7_budget_allocation_enabled', label: '♻️ R7 Budget', default: false, tip: 'Round 7 budget allocation challenge: students must prioritize competing sustainability investments under constrained capital. Reflection exercise — recorded for the debrief, no engine effect. OFF by default.' },
                                        { key: 'r8_tribunal_enabled', label: '⚖️ R8 Tribunal', default: false, tip: 'Round 8 stakeholder tribunal: students face a simulated ESG tribunal and must justify their track record. Reflection exercise — recorded for the debrief, no engine effect. OFF by default.' },
                                    ].map(t => (
                                        <div key={t.key} className={styles.pillWrap} data-tip={t.tip}>
                                        <button
                                            onClick={() => togglePill(t)}
