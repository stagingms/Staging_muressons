...
const BRIEFINGS = {
  ...
  3: {
    ...
    narrative: [
      ...
      'The financial stakes are real. Scope 3 emissions will eventually feed into your <strong>Natural Capital Debt (NCD)</strong> — a running tally of your environmental liability that compounds over rounds and directly affects your 2050 Terminal Valuation. Ignoring it now means paying more later.',
  ...
  5: {
    ...
    narrative: [
      ...
      'The implications extend beyond this round. Your resilience strategy here feeds into your <strong>2050 Regenerative Multiple</strong>. Choosing the insurance-only path signals to investors that you are not building genuine climate resilience — and it will block a critical +0.20 bonus in your final valuation.',
    ],
    objectives: [
  ...
  6: {
    ...
    narrative: [
      ...
      'You face a profound ethical crossroads. A full <strong>Ethical AI Overhaul</strong> costs $8M but builds genuine social capital and unlocks the coveted <em>Truth Premium</em> at Round 10 — a +0.15 bonus to your Regenerative Multiple. A quiet patch costs only $1M but increases governance risk by 10 points. Your choice here will echo through your 2050 Terminal Valuation and define what kind of company Muressons truly is.',
    ],
    objectives: [
 ...
 */
export default function RoundBriefing({ roundNumber, onProceed }) {
  const b = BRIEFINGS[roundNumber];
  if (!b) return null;
