                ...
                {sortedUnits.map((bu, i) => {
                    ...
                    return (
                        <div key={bu.bu_id} className={cardClasses}
                            ...
                            {/* CA-C: health verdict as a chip (promoted from the
                                8px corner dot) with a one-line investment thesis. */}
                            {(() => {
                                const thesis = getBuThesis(bu);
                                return (
                                    <div className={`${styles.healthChip} ${styles[`healthChip${health.charAt(0).toUpperCase() + health.slice(1)}`]}`}
                            ...
                            <div className={styles.sliderHeader}>
                                ...
                                <div className={styles.buInfo}>
                                    ...
                                    <span className={styles.buThesis}>{getBuThesis(bu).reason}</span>
                                </div>
