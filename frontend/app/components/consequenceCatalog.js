...
export const CONSEQUENCE_CATALOG = {
  ...
  climate_tipping_penalties_applied: {
    ...
    mechanism: 'A tipped climate subsystem marks natural-capital debt up 50% once and caps group reputation at 60 while tipped.',
    severity: 'bad',
    icon: '🔥',
    explain: () => 'The climate subsystem has tipped: your natural-capital debt was marked up once and your reputation is capped at 60.',
  },
  social_tipping_penalties_applied: {
    label: 'Social System Penalties',
    mechanism: 'A tipped social subsystem adds a permanent 5% step to the OPEX base once and caps social licence at 50 while tipped.',
    severity: 'bad',
    icon: '✊',
    explain: () => 'The social subsystem has tipped — a permanent 5% OPEX surcharge landed once and social licence is capped at 50.',
  },
  financial_tipping_penalties_applied: {
    label: 'Financial System Penalties',
    mechanism: 'A tipped financial subsystem adds 4 points to the cost of capital once, caps CapEx at 50% and suspends dividends while tipped.',
    severity: 'bad',
    icon: '🏦',
    explain: () => 'The financial subsystem has tipped: the cost of capital stepped up 4 points, CapEx is capped at 50% and dividends are suspended.',
  },
