    ...
    },
    {
        ...
        vars: [
            ...
            { key: 'synergy_multiplier',  formKey: 'synergy_multiplier_start',  scope: 'Global', boundary: '[1.0, 1.35×]', editable: true, step: 0.1,
              tooltip: 'Lowers global OPEX across all BUs via the calc_synergy_opex formula. Option C in Round 7 (VRIO Restructuring) unlocks a +0.30 boost, heavily boosting profitability. But beware — the imitation_decay_rate erodes this advantage by 5% every round, simulating competitor catch-up.',
              logic: 'Lowers global OPEX through the calc_synergy_opex formula. Option C in R7 unlocks a +0.30 multiplier, heavily boosting profitability.',
              refs: ['opex_base'] },
    ...
    },
    {
        ...
        vars: [
            ...
            { key: 'social_license_score', formKey: null, scope: 'BU Level', boundary: '[0.0, 100.0]', editable: false, defaultDisplay: 'Soft: 60 · Phar: 55 · Other: ~50',
              tooltip: 'Community trust metric per BU (0–100). Critical threshold: if avg(SL) < 50 in Round 9, strike probability overrides to 50%, potentially zeroing out all BU revenue for that round. Improved by social investment CapEx and ethical decision-making across rounds.',
              logic: 'Local community trust. Determines Strike Probability in R9: p = calc_strike_probability(base_risk, SL). If avg(SL) < 50 in R9, probability overrides to 50% for revenue zeroization.',
    ...
    return (
        ...
        >
            ...
            <div style={{ padding: '16px 18px 14px' }}>
                ...
                <div style={{ fontSize: 'var(--type-caption)', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '10px', lineHeight: 1.3 }}>
                    {humanize(v.key)}
                </div>
                ...
                >
                    <div style={{
                        fontSize: 'var(--type-caption)', color: 'var(--text-muted)', lineHeight: 1.65,
                        overflow: 'hidden',
                ...
                {v.refs && v.refs.length > 0 && (
                    <div style={{ display: 'flex', gap: '4px', flexWrap: 'wrap', marginTop: '8px' }}>
                        <span style={{ fontSize: 'var(--type-caption)', color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', alignSelf: 'center', marginRight: '2px' }}>
                            Refs:
                        </span>
                        {v.refs.map(r => (
                            <span key={r} style={{
    ...
    return (
        <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', fontFamily: 'var(--font-sans,system-ui,sans-serif)' }}>
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
                        <span style={{ fontSize: 'var(--type-caption)', fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
            ...
            <div style={{
                ...
                border: hasChanges ? '1px solid rgba(99,102,241,0.4)' : '1px solid var(--border-subtle)',
                borderRadius: '12px',
